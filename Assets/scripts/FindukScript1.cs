...
public class FindukScript1 : MonoBehaviour
{
    float Power = 6;
    GameObject cam;
    AudioSystemScript SoundManager;

    ScriptManagerInThisLevel1 managerGame;
    


    void Awake()
    {
        managerGame = GameObject.FindGameObjectWithTag("GameManagerMy").GetComponent<ScriptManagerInThisLevel1>();
